...
export default class FullEvo2 extends FullEvo {
    override  getInfo(): EngineInfo {
        ...
        info.version = 2
        info.description = "Изменен принцип столкновения клеток. На одной клетке временно может быть несколько ботов. Но, стволовые сливаются сразу, делясь негами. " +
            ...
            "Органика плавно падают вниз и накапливается на дне."
        return info
    }
